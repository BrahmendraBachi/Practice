...
public class MovieArtist implements Artist {
    ...
    public MovieArtist(String name, int age, Gender gender, String phoneNumber, String emailId, Profession profession, String fatherName,
